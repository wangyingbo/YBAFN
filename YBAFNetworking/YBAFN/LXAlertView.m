...
#define VIEWLAYOUTALERTVIEW_W  [UIScreen mainScreen].bounds.size.width/375
#define VIEWLAYOUTALERTVIEW_H  [UIScreen mainScreen].bounds.size.height/667

#define AlertView_W     270.0f*VIEWLAYOUTALERTVIEW_W
#define MessageMin_H    60.0f*VIEWLAYOUTALERTVIEW_H       //messagelab的最小高度
#define MessageMAX_H    120.0f*VIEWLAYOUTALERTVIEW_H      //messagelab的最大高度，当超过时，文本会以...结尾
#define LXATitle_H      20.0f*VIEWLAYOUTALERTVIEW_H
#define LXABtn_H        30.0f*VIEWLAYOUTALERTVIEW_H
...
#define SFQMainColor        [UIColor colorWithRed:35/255.0 green:183/255.0 blue:156/255.0 alpha:1]
...
//static LXAlertView *_singleAlertView;
//单例类
//+(LXAlertView *)sharedInstance
//{
//    @synchronized (self)
//    {
//        if (_singleAlertView ==nil) {
//            _singleAlertView = [[self alloc]init];
//        }
//        
//    }
...
//        if (!_singleAlertView)
//        {
//            _singleAlertView = [super allocWithZone:zone];         }
//        }
//    return _singleAlertView;
//}
